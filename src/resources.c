...
#define SECTION                                                                                    \
    __attribute__((section(".gresource.main"), aligned(sizeof(void *) > 8 ? sizeof(void *) : 8)))
#else
#define SECTION
#endif
...
static GStaticResource static_resource = {main_resource_data.data,
                                          sizeof(main_resource_data.data) - 1 /* nul terminator */,
                                          NULL,
                                          NULL,
                                          NULL};
